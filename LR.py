...
st.set_page_config(page_title="NeoToolkit", layout="wide")
                    ...
                    if location_query:
                        try:
                            with st.spinner("🔍 Searching location..."):
                                geolocator = Nominatim(user_agent="neotoolkit_v2")
...
st.markdown("""
    <div style="text-align: center; padding: 2rem 0;">
        <p style="font-size: 1.2rem; color: #00ffff; font-weight: bold;">💼 NeoToolkit</p>
